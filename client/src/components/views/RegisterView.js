    ...
    <div className="register-view">
      ...
      <Form onSubmit={registerHandler}>
        <Form.Group className="mb-3" controlId="formBasicEmail">
          ...
          <Form.Control type="username" placeholder="Enter username" required id="username" value={username} onChange={(e) => setUsername(e.target.value)} />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formBasicPassword">
          ...
          <Form.Control type="password" placeholder="Confirm password" required id="password-confirmation" value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} />
        </Form.Group>
